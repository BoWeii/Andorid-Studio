...
public class MainActivity extends AppCompatActivity {
    ...
    private final LinkedList<String> Lyric = new LinkedList<>();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String[] lyric= getResources().getStringArray(R.array.lyric);
        for(String t:title)
            mWordList.addLast(t);
        for(String c:content)
            mWordList2.addLast(c);
        for(String l:lyric)
            Lyric.addLast(l);
        ...
        mAdapter = new WordListAdapter(this, mWordList,mWordList2,Lyric,img);
